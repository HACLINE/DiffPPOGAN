...
class DiffPPOGANWorkspace(BaseWorkspace):
    ...
    def update_schedule(self):
        ...
        self.total_reward_weight = self.reward_schedule[:self.tune_timesteps].sum()
        self.reward_cumsum = self.reward_schedule.cumsum(dim=0)
    ...
    def train_model(self):
        ...
        for epoch in epoch_bar:
            ...
            if self.eval_fid_every > 0 and (self.model_update_epoch + 1) % self.eval_fid_every == 0 and self.model_update_epoch not in FID_list:
